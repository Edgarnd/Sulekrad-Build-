...
public class Enemigo {
	...
	private HojaSprites hs = new HojaSprites(Constantes.RUTA_ENEMIGOS + "1.png", Constantes.LADO_SPRITE, false);
	private BufferedImage enemigoGolpeado = hs.obtenerSprite(0).obtenerImagen();
	...
	public Rectangle obtenerArea() {
		final int puntoX = (int) posicionX - (int) ElementosPrincipales.jugador.obtenerPosicionX()
				+ Constantes.MARGEN_X;
		final int puntoY = (int) posicionY - (int) ElementosPrincipales.jugador.obtenerPosicionY()
				+ Constantes.MARGEN_Y;
